...
ACCOUNT_AUTHENTICATION_METHOD = 'phone_email'
"""
...
REST_AUTH_REGISTER_SERIALIZERS ={
    'REGISTER_SERIALIZER': 'backend.user.serializers.RegisterSerializer'
}

REST_AUTH_SERIALIZERS ={
    "LOGIN_SERIALIZER": 'backend.user.serializers.LoginSerializer'
}